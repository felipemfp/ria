...
const decisionTreeClassifier = ({mediaFinal, faltas, renda, coefRendimento, frequencia}) => {
...
export const classifier = (item) => {
    const [[apprFactor, dropFactor, reprFactor]] = decisionTreeClassifier(item)
